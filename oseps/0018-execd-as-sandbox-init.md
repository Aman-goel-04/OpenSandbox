...
> (custom seccomp/caps e2e), R-s (EXECD_INIT drift pin), R-l(b) (K8s
> Restart recycle e2e), R-m (default-off + sustained fork-heavy) and R-u
> (runtime-initiated stop e2e) landed in the init/hardening e2e suites.
