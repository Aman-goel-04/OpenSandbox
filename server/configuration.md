...
| `pool_acquisition_timeout_seconds` | integer | `30` | Max continuous time to wait while Pool capacity prevents allocation. This does not extend `sandbox_create_timeout_seconds`. |
