...
class LifecycleHook private constructor(
    ...
    class Builder {
        ...
        fun timeoutSeconds(timeoutSeconds: Int): Builder {
            require(timeoutSeconds > 0) { "Lifecycle hook timeoutSeconds must be positive" }
...
class PeriodicLifecycleHook private constructor(
    ...
    class Builder {
        ...
        fun timeoutSeconds(timeoutSeconds: Int): Builder {
            require(timeoutSeconds > 0) { "Periodic lifecycle hook timeoutSeconds must be positive" }
            this.timeoutSeconds = timeoutSeconds
            return this
        }
